...
type AliyundriveTVOpen struct {
	...
	ref       *AliyundriveTVOpen
}

func (d *AliyundriveTVOpen) Config() driver.Config {
	return config
}

func (d *AliyundriveTVOpen) GetAddition() driver.Additional {
	return &d.Addition
}

func (d *AliyundriveTVOpen) Init(ctx context.Context) error {
...
func (d *AliyundriveTVOpen) InitReference(storage driver.Driver) error {
	refStorage, ok := storage.(*AliyundriveTVOpen)
	if ok {
		d.ref = refStorage
		return nil
	}
...
func (d *AliyundriveTVOpen) Drop(ctx context.Context) error {
	d.ref = nil
	return nil
}

// GetRoot implements the driver.GetRooter interface to properly set up the root object
func (d *AliyundriveTVOpen) GetRoot(ctx context.Context) (model.Obj, error) {
	return &model.Object{
		ID:       d.RootFolderID,
		Path:     "/",
		Name:     "root",
...
func (d *AliyundriveTVOpen) List(ctx context.Context, dir model.Obj, args model.ListArgs) ([]model.Obj, error) {
	if d.limitList == nil {
...
func (d *AliyundriveTVOpen) link(ctx context.Context, file model.Obj) (*model.Link, error) {
...
func (d *AliyundriveTVOpen) Link(ctx context.Context, file model.Obj, args model.LinkArgs) (*model.Link, error) {
	if d.limitLink == nil {
		return nil, fmt.Errorf("driver not init")
	}
...
func (d *AliyundriveTVOpen) MakeDir(ctx context.Context, parentDir model.Obj, dirName string) (model.Obj, error) {
...
func (d *AliyundriveTVOpen) Move(ctx context.Context, srcObj, dstDir model.Obj) (model.Obj, error) {
...
func (d *AliyundriveTVOpen) Rename(ctx context.Context, srcObj model.Obj, newName string) (model.Obj, error) {
	var newFile File
...
func (d *AliyundriveTVOpen) Copy(ctx context.Context, srcObj, dstDir model.Obj) error {
	var resp MoveOrCopyResp
...
func (d *AliyundriveTVOpen) Remove(ctx context.Context, obj model.Obj) error {
...
func (d *AliyundriveTVOpen) Put(ctx context.Context, dstDir model.Obj, stream model.FileStreamer, up driver.UpdateProgress) (model.Obj, error) {
...
func (d *AliyundriveTVOpen) Other(ctx context.Context, args model.OtherArgs) (interface{}, error) {
	var resp base.Json
	var uri string
	data := base.Json{
		"drive_id": d.DriveId,
...
var _ driver.Driver = (*AliyundriveTVOpen)(nil)
var _ driver.MkdirResult = (*AliyundriveTVOpen)(nil)
var _ driver.MoveResult = (*AliyundriveTVOpen)(nil)
var _ driver.RenameResult = (*AliyundriveTVOpen)(nil)
var _ driver.PutResult = (*AliyundriveTVOpen)(nil)
var _ driver.GetRooter = (*AliyundriveTVOpen)(nil)
