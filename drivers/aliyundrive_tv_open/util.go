...
func (d *AliyundriveTVOpen) refreshToken() error {
	if d.ref != nil {
...
func (d *AliyundriveTVOpen) request(uri, method string, callback base.ReqCallback, retry ...bool) ([]byte, error) {
	b, err, _ := d.requestReturnErrResp(uri, method, callback, retry...)
	return b, err
}

func (d *AliyundriveTVOpen) requestReturnErrResp(uri, method string, callback base.ReqCallback, retry ...bool) ([]byte, error, *ErrResp) {
...
func (d *AliyundriveTVOpen) list(ctx context.Context, data base.Json) (*Files, error) {
	var resp Files
...
func (d *AliyundriveTVOpen) getFiles(ctx context.Context, fileId string) ([]File, error) {
	marker := "first"
	res := make([]File, 0)
	for marker != "" {
		if marker == "first" {
...
func (d *AliyundriveTVOpen) getAccessToken() string {
	if d.ref != nil {
...
func (d *AliyundriveTVOpen) removeDuplicateFiles(ctx context.Context, parentPath string, fileName string, skipID string) error {
