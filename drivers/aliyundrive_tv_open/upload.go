...
import (
	...
	streamPkg "github.com/kinyokun/OpenList/internal/stream"
...
func (d *AliyundriveTVOpen) getUploadUrl(count int, fileId, uploadId string) ([]PartInfo, error) {
...
func (d *AliyundriveTVOpen) uploadPart(ctx context.Context, r io.Reader, partInfo PartInfo) error {
...
func (d *AliyundriveTVOpen) completeUpload(fileId, uploadId string) (model.Obj, error) {
	// 3. complete
	var newFile File
...
func (d *AliyundriveTVOpen) calProofCode(stream model.FileStreamer) (string, error) {
...
func (d *AliyundriveTVOpen) upload(ctx context.Context, dstDir model.Obj, stream model.FileStreamer, up driver.UpdateProgress) (model.Obj, error) {
	// 1. create
